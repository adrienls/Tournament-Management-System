        ...
        <div class="container-fluid">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col">
                        ...
                        if(isGeneratedDays($_GET['id'])) {
                            ...
                            echo "<p><a class='btn btn-primary btn-sm' href=\"../../../Controller/controller-Planning.php?func=exportPlanning&id=".$_GET['id']."&name=".$_GET['name']."\" role='button'>Export Planning</a></p>";
                        }
                        else {
                            echo "<p><a class='btn btn-primary btn-sm disabled' tabindex=\"-1\" href='#' role='button' aria-disabled='true'>Export Planning</a></p>";
                ...
                if (isPlayedDays($_GET["id"])) {
                    ...
                    echo "<p><a class='btn btn-primary btn-sm' href=\"../../../Controller/controller-Planning.php?func=exportRanking&id=".$_GET['id']."&name=".$_GET['name']."\" role='button'>Export Ranking</a></p>";
